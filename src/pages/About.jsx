    ...
    <section className="px-8 md:px-16 py-20">
      <div className="flex flex-col md:flex-row items-start justify-between gap-10 mb-16">
        ...
        >
          ...
          {/* Thin ash outlined ring, slowly rotating clockwise */}
          <div className="absolute w-[110%] h-[110%] border border-ash-dark blob-shape animate-spin-slow" />

          {/* Thin white outlined ring, slowly rotating counter-clockwise, slightly bigger */}
      ...
      >
        ...
        <div className="flex flex-col gap-6">
          <div className="border-l-2 border-ash-dark pl-6">
            <p className="text-offwhite font-semibold">Master of Computer Applications (MCA)</p>
            <p className="text-ash text-sm mt-1">Mangalam College of Engineering, Kottayam, Kerala</p>
            <p className="text-ash text-xs mt-1 uppercase tracking-wide">2023 – 2025</p>
          </div>

          <div className="border-l-2 border-ash-dark pl-6">
            <p className="text-offwhite font-semibold">Bachelor of Computer Applications (BCA)</p>
            <p className="text-ash text-sm mt-1">Fr. Porukkara CMI College of Advanced Studies, Alappuzha</p>
            <p className="text-ash text-xs mt-1 uppercase tracking-wide">2020 – 2023</p>
          </div>
        </div>
      </motion.div>
          <p className="text-ash-light text-lg leading-relaxed mb-6">
            I'm Krishnendhu KM, a Full Stack Developer who enjoys building
            clean, functional web applications from scratch. I work primarily
            with the MERN stack, and I'm always looking to sharpen my skills
          ...
          <p className="text-ash leading-relaxed mb-8">
            ...
            build on. Whether it's the frontend experience or the backend
            logic, I care about getting the details right.
          </p>

          <a href="/documents/resume.pdf" download className="inline-flex items-center gap-2 bg-offwhite text-base-black px-6 py-3 text-sm font-semibold uppercase tracking-wide hover:bg-ash-light transition-colors">
            ...
            <div key={category.title} className="mb-8">
              ...
              <div className="flex flex-wrap gap-3">
                {category.skills.map((skill) => (
                  <span key={skill} className="text-ash-light text-sm border border-ash-dark px-4 py-2 hover:border-ash hover:text-offwhite transition-colors cursor-default">
                    {skill}
                  </span>
                ))}
              </div>
